...
from .forms import CommentForm, MessageForm, PostForm, ShareForm, ThreadForm
from .models import (Comment, Image, MessageModel, Notification, Post,
                     ThreadModel, UserProfile)
